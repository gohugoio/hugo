...
func TestTreeShiftTree(t *testing.T) {
	...
	tree := doctree.NewTreeShiftTree[string](sitematrix.Vector{10, 1, 1})
	...
	b.Run("New", func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			for l1 := 0; l1 < v[0]; l1++ {
				for l2 := 0; l2 < v[1]; l2++ {
					for l3 := 0; l3 < v[2]; l3++ {
						_ = doctree.NewTreeShiftTree[string](sitematrix.Vector{l1, l2, l3})
					}
				}
			}
		}
	...
	b.Run("Shape", func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			for l1 := 0; l1 < v[0]; l1++ {
				for l2 := 0; l2 < v[1]; l2++ {
					for l3 := 0; l3 < v[2]; l3++ {
						t.Shape(sitematrix.Vector{l1, l2, l3})
					}
				}
			}
		}
