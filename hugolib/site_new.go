...
func NewHugoSites(cfg deps.DepsCfg) (*HugoSites, error) {
	...
	resourceTreeConfig := doctree.Config[contentNodeI]{
		MatrixRow: matrixRow,
		Shifter:   ns,
	}
	...
	pageTrees := &pageTrees{
		...
		treeTaxonomyEntries: doctree.NewTreeShiftTree[*weightedContentNode](pageTreeDimensionLanguage, len(confm.Languages)),
	}
...
func (s *Site) ForEeachIdentityByName(name string, f func(identity.Identity)) {
