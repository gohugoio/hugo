...
var _ sitesmatrix.DimensionInfo = (*VersionSite)(nil)
...
type Version interface {
	Name() string
	Site() Site // TODO1 keep? Maybe move to sitesmatrix.DimensionInfo?
}
...
func (r *VersionsInternal) init(defaultContentVersion string) error {
	...
	dfaultContentVersionProvided := defaultContentVersion != ""
	...
	if !defaultSeen {
		if dfaultContentVersionProvided {
