...
{{ .AddResource (dict "path" "p1/hello.txt" "title" "Hello scandinavia" "content" $contentTextNorsk "sites" (dict "matrix"  $scandinavia "fallbacks" $da )) }}
-- layouts/all.html --
...
`
	...
	// b.AssertFileContent("public/da/p1/index.html", "P1 da|", "adsf")
}
