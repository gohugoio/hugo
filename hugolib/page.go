...
// Exported to be used in templates.DebugLayoutLookup.
func (po *pageOutput) GetInternalTemplateBasePathAndDescriptor() (string, any) {
	return po.getInternalTemplateBasePathAndDescriptor()
}
