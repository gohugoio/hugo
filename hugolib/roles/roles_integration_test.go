...
Roles: {{ range .Site.Roles }}Name: {{ .Name }}|{{ end }}$
Versions: {{ range site.Versions }}Name: {{ .Name }}|{{ end }}$
...
`
	...
	for range 3 {
		...
		b.AssertFileContent("public/guest/v2.0.0/en/index.html",
			...
			"Roles: Name: member|Name: guest|$",
			"Versions: Name: v4.0.0|Name: v3.0.0|Name: v2.1.0|Name: v2.0.0|Name: v1.2.3|$")
