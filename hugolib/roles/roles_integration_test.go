...
`
	...
	b.AssertFileContent("public/guest/v2.0.0/en/index.html",
		...
		"Versions: Name: v2.1.0 Site.Role: guest Site.Language.Lang: en|Name: v2.0.0 Site.Role: guest Site.Language.Lang: en|Name: v1.2.3 Site.Role: guest Site.Language.Lang: en|$")
}
