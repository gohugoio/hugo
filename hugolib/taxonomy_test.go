...
`
	...
	cat1, _ := s.getPage("categories/cat1")
	...
	pl1, _ := s.getPage("permalinkeds/pl1")
	permalinkeds, _ := s.getPage("permalinkeds")
	...
	if preserveTaxonomyNames {
		helloWorld, _ := s.getPage("others/Hello Hugo world")
