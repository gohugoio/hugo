...
func TestTableOfContentsInShortcodes(t *testing.T) {
	...
	// Not checking the heading-ids because they are not generated by the ToC.
	assertFileContentRegexp(t, "public/en/post/simple/index.html", true, tocPageSimpleExpected)
	assertFileContentRegexp(t, "public/en/post/withSCInHeading/index.html", true, tocPageWithShortcodesInHeadingsExpected)
}
...
<li><a href="[^"]*">Heading 1</a>
<ul>
<li><a href="[^"]*">Subheading 1.1 Shortcode: Hello</a></li>
</ul></li>
<li><a href="[^"]*">Heading 2 Shortcode: Hello</a>
<ul>
<li><a href="[^"]*">Subheading 2.1</a></li>
</ul></li>
</ul>
