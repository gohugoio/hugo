...
func TestDimensionsDistance(t *testing.T) {
	...
	c.Assert(Dimensions{1, 2, 3}.Distance(Dimensions{1, 2, 8}), qt.Equals, -5)
	c.Assert(Dimensions{1, 2, 3}.Distance(Dimensions{1, 2, 3}), qt.Equals, 0)
	c.Assert(Dimensions{1, 2, 3}.Distance(Dimensions{1, 2, 0}), qt.Equals, 3)
	c.Assert(Dimensions{1, 2, 3}.Distance(Dimensions{1, 0, 3}), qt.Equals, 2)
	c.Assert(Dimensions{1, 2, 3}.Distance(Dimensions{0, 3, 2}), qt.Equals, 1)
}
