...
`
	...
	b.AssertFileContent("public/fr/index.html", "fr: /fr/bundle/data.txt|Data fr")
	b.AssertFileContent("public/en/index.html", "en: /en/bundle/data.txt|Data en")
	b.AssertFileContent("public/de/index.html", "de: /fr/bundle/data.txt|Data fr")
}
