...
func (m *Mount) init(logger logg.Logger) error {
	if m.Lang != "" {
		...
		hugo.DeprecateWithLogger("module.mounts.lang", "Replaced by the more powerful 'sites.matrix' setting, see https://gohugo.io/docs/reference/configuration/modules/#sites", "v0.153.0", logger)
	}
