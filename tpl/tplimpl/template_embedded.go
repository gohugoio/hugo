...
{{ end }}`)
	...
	t.addInternalShortcode("telegram.html", `<script async src="https://telegram.org/js/telegram-widget.js?1" data-telegram-post="{{ index .Params 0 }}/{{ index .Params 1 }}" data-width="100%"></script>`)
}
