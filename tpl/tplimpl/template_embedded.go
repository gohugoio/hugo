...
{{ end }}`)
	...
	twitterTmpl :=  `{{ (getJSON "https://api.twitter.com/1/statuses/oembed.json?id=" (index .Params 0)).html | safeHTML }}`
	t.addInternalShortcode("tweet.html", twitterTmpl)
	t.addInternalShortcode("twitter.html", twitterTmpl)
