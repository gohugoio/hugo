...
Hugo now handles the **archetype files as Go templates**. This means that the issues with sorting and lost comments are long gone. But this also means that you will have to supply all values, including title and date. But this also opens up a lot of new windows.
...
**Also, Hugo now supports archetype files for all content types, not just markdown.**
