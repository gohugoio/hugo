...
- [`hugo-content.schema.json`](hugo-content.schema.json) - Page frontmatter schema with flexible date handling and build options
...
```json
{
  "yaml.schemas": {
    ...
    "https://gohugo.io/jsonschemas/hugo-content.schema.json": [
      "content/**/*.md",
      "archetypes/*.md"
    ]
  },
...
- Page frontmatter: `https://gohugo.io/jsonschemas/hugo-content.schema.json`
