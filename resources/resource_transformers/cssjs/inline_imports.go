	...
	for offset, line := range lines {
		...
		if !imp.shouldImport(line) {
			...
			if importContent == nil {
				...
				msgDetail := "if this import's source lives in node_modules, enable the skipInlineImportsNotFound option, see https://gohugo.io/docs/reference/functions/css/postcss/#skipinlineimportsnotfound"
