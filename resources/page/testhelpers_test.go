...
type testPage struct {
	description string // TODO(bep) page check interface
	title       string
	linkTitle   string
...
func (p *testPage) SearchKeywords(cfg related.IndexConfig) ([]related.Keyword, error) {
...
func (p *testPage) SourceRef() string {
	panic("not implemented")
}
