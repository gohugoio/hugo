...
func NewLazyContentProvider(f func() (OutputFormatContentProvider, error)) *LazyContentProvider {
	...
	lcp.init.Add(func(ctx context.Context) (interface{}, error) {
		cp, err := f()
		if err != nil {
			return nil, err
		}
...
func (lcp *LazyContentProvider) Content(ctx context.Context) (interface{}, error) {
	lcp.init.Do(ctx)
...
func (lcp *LazyContentProvider) RenderString(ctx context.Context, args ...interface{}) (template.HTML, error) {
	lcp.init.Do(ctx)
