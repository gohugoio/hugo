...
// Mastodon holds the privacy configuration settings related to the Mastodon shortcode.
type Mastodon struct {
	Service `mapstructure:",squash"`

	// TODO: revisit it
	// If simple mode is enabled, a static and no-JS version of the Toot will be built.
	Simple bool
}
