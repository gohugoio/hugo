...
var publishCmd = &cobra.Command{
	Use:   "publish path/to/content",
	Short: "Publish the specified draft content",
	Long:  `Publish the specified draft content and set it's publish date to now.`,
	Run:   Publish,
}
...
func Publish(cmd *cobra.Command, args []string) {
	...
	w, err := publishContent(p)
	if err != nil {
		jww.ERROR.Println("an error occurred while publishing %q: %s", location, err)
		return
	}
...
// publishContent
func publishContent(p parser.Page) (bytes.Buffer, error) {
